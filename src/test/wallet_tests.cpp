...
BOOST_AUTO_TEST_CASE(coin_selection_tests)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        BOOST_CHECK( wallet.SelectCoinsMinConf(500000 * BREADCRUMB, 1, 1, vCoins, setCoinsRet, nValueRet));
        ...
        BOOST_CHECK( wallet.SelectCoinsMinConf(1.0001 * BREADCRUMB, 1, 1, vCoins, setCoinsRet, nValueRet));
        BOOST_CHECK_EQUAL(nValueRet, 1.0105 * BREADCRUMB);   // we should get all coins
        BOOST_CHECK_EQUAL(setCoinsRet.size(), 3U);

        // but if we try to make 0.999, we should take the bigger of the two small coins to avoid sub-cent change
        BOOST_CHECK( wallet.SelectCoinsMinConf(0.999 * BREADCRUMB, 1, 1, vCoins, setCoinsRet, nValueRet));
        ...
        // test randomness
        {
            ...
            BOOST_CHECK(wallet.SelectCoinsMinConf(50 * BREADCRUMB, 1, 6, vCoins, setCoinsRet , nValueRet));
            BOOST_CHECK(wallet.SelectCoinsMinConf(50 * BREADCRUMB, 1, 6, vCoins, setCoinsRet2, nValueRet));
            ...
            for (int i = 0; i < RANDOM_REPEATS; i++)
            {
                ...
                BOOST_CHECK(wallet.SelectCoinsMinConf(BREADCRUMB, 1, 6, vCoins, setCoinsRet , nValueRet));
                BOOST_CHECK(wallet.SelectCoinsMinConf(BREADCRUMB, 1, 6, vCoins, setCoinsRet2, nValueRet));
