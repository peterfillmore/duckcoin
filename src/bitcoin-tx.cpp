...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Duckcoin Core duckcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  duckcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded duckcoin transaction") + "\n" +
              "  duckcoin-tx [options] -create [commands]   " + _("Create hex-encoded duckcoin transaction") + "\n" +
              "\n";
