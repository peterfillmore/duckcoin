...
#ifndef BITBREADCRUMB_QT_BITBREADCRUMBUNITS_H
#define BITBREADCRUMB_QT_BITBREADCRUMBUNITS_H
...
public:
    ...
    //! Number of Silvios (1e-8) per unit
    ...
    //! Return maximum number of base units (Silvios)
...
#endif // BITBREADCRUMB_QT_BITBREADCRUMBUNITS_H
