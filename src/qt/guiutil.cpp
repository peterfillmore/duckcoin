...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Duckcoin address (e.g. %1)").arg("Ler4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2"));
#endif
...
bool parseBitcoinURI(QString uri, SendBreadcrumbsRecipient *out)
{
    ...
    if(uri.startsWith("duckcoin://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "duckcoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Duckcoin.lnk";
}
...
{
    return GetAutostartDir() / "duckcoin.desktop";
}
