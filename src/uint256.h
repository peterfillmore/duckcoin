...
#ifndef BITBREADCRUMB_UINT256_H
#define BITBREADCRUMB_UINT256_H
...
public:
     ...
     * 
     * Silvio's original implementation used BN_bn2mpi() and BN_mpi2bn().
