...
### Download the Blockchain from the DuckcoinNode Project

The Duckcoin node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by DuckcoinNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.duckcoinnode.org/bootstrap.dat](http://mango.duckcoinnode.org/bootstrap.dat)
* [http://apple.duckcoinnode.org/bootstrap.dat](http://apple.duckcoinnode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.duckcoinnode.org/bootstrap.dat](http://bootstrap.duckcoinnode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.duckcoinnode.org/bootstrap.dat       //downloads bootstrap into current directory
